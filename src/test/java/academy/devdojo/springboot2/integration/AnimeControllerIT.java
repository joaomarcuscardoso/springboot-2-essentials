...
import academy.devdojo.springboot2.repository.util.AnimeCreator;
import academy.devdojo.springboot2.repository.util.AnimePostRequestBodyCreator;
...
class AnimeControllerIT {
    ...
    private static final DevDojoUser USER = DevDojoUser.builder()
            .name("Joujou")
            .password("{bcrypt}$2a$10$RwtYft6QkrCmkMmtxEdHreGZRa2lV2X6.brgGneCIuTPaH39ks1K.")
            .username("joujou")
    ...
    static class Config {
        ...
        public TestRestTemplate testRestTemplateRoleUserCreator(@Value("${local.server.port}") int port) {
            RestTemplateBuilder restTemplateBuilder=  new RestTemplateBuilder()
                    ...
                    .basicAuthentication("joujou", "academy");
        ...
        public TestRestTemplate testRestTemplateRoleAdminCreator(@Value("${local.server.port}") int port) {
            RestTemplateBuilder restTemplateBuilder=  new RestTemplateBuilder()
                    .rootUri("http://localhost:"+port)
                    .basicAuthentication("joaomarcus", "academy");
